...
/** Exported for 008's post chain, which composites everything at or above this order
 *  over the effects rather than through them: the readout must stay legible, while the
 *  view-model at 900 and its muzzle flash go through the chain, which is what US4-S6
 *  measures. */
