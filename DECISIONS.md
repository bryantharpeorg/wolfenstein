...
- 2026-08-31 | 006-enemies | `tools/smoke.mjs` gained the `tools/smoke-checks/*.mjs` discovery loop in US4 rather than US3, because US3 had not landed when US4 needed it; T027's own instruction is to reuse such a loop and add no line.
