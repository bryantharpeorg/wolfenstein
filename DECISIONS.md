...
- 2026-08-30 | 004-interaction | `interactDoor` answers `blocked-moving` for an opening door and `refusing-closing` for a closing one — FR-003 names both outcomes, and this is the only assignment under which each is reachable.
