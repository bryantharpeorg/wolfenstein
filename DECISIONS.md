...
- 2026-08-31 | 005-materials | US4 ships four point lights with two shadow maps, `LIGHT_DECAY = 1` and `FOG_FAR = 90` against a 61-unit sight-line: two casters are what the smoke gate's software renderer affords, and linear falloff is the only one that lights a twenty-tile corridor without blowing out the tile under the lamp.
